    ...
    <aside>
      <section>
        <div>
          ...
          <ul className="chats">
            <li className="chat">
              <img src={defaultGroup} alt="Kweebac's profile picture" />
              <div className="info">
        ...
        <div>
          ...
          <ul className="chats">
            ...
            <li className="chat">
              <div className="img">
                <img src={defaultUser} alt="A1yssa's profile picture" />
                <div className="offline"></div>
              </div>
              <div className="info">
                <div>A1yssa</div>
                <div>I&apos;m editting editting editting editting editting editting ^-^</div>
              </div>
            </li>
          </ul>
        </div>
